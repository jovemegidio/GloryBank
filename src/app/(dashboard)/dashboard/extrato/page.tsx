...
export default function ExtratoPage() {
  ...
  const exportPDF = () => {
    ...
    printWin.document.write(`<!DOCTYPE html><html><head><title>Extrato CredBusiness</title>
      ...
      .header{text-align:center;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid #00A650}
      .header h1{color:#00A650;font-size:22px}.header p{color:#64748b;font-size:12px;margin-top:4px}
