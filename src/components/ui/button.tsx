...
const variants = {
  primary:
    "bg-emerald-600 text-white hover:bg-emerald-700 focus:ring-emerald-500/40 shadow-lg shadow-emerald-600/20",
  secondary:
    "bg-slate-100 text-slate-700 hover:bg-slate-200 focus:ring-slate-400/40",
  outline:
    "border border-emerald-500/30 text-emerald-700 hover:bg-emerald-500/10 focus:ring-emerald-500/40",
  ghost:
